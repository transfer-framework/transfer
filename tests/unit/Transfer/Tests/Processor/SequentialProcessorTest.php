...
class SequentialProcessorTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->assertEquals('Sequential processor', $this->processor->getName());
    }
    ...
    public function testProcess()
    {
        ...
        $this->assertEquals(array('a', 'a', 'b', 'b', 'c', 'c'), $actual);
    }
}
